#!/usr/bin/env elixir
# Demo: Rheo ops control panel + LiveDashboard via Phoenix Playground.
#
# From the repo root:
...
#
# Opens http://localhost:4000/ (control) and /dashboard/rheo.
# See https://hex.pm/packages/phoenix_playground and ADR 027.

Mix.install(
  [
    {:rheo, path: Path.expand("..", __DIR__)},
...
defmodule Demo.Seed do
  ...
  def run do
    ...
    {:ok, info} = Rheo.group_info(@stream, "risk", rheo: DemoRheo)
    ...
    Seeded DemoRheo:
      ...
      risk DLQ:  #{info.dead_letter_count}
    """)
