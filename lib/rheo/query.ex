defmodule Rheo.Query do
  ...
  Part of the SemVer-frozen surface (ADR 029 / ADR 030). Field meanings and
  page-cursor shape (`%{partition => after_sequence}`, legacy
  `%{after_sequence: n}` still accepted) will not change without a major
  version.
