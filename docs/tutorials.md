...
Medium-oriented tutorial notes for Rheo **v0.7.0**:
...
13. [One consumer API, PostgreSQL and SQLite underneath](tutorials/13-one-consumer-api-postgresql-and-sqlite.md)
14. [Rheo is not Broadway — it feeds Broadway](tutorials/14-rheo-is-not-broadway-it-feeds-broadway.md) — GenStage producer, lease-aware acknowledger
...
ETS by default, optional SQLite/Ecto section). Upgrade notes:
